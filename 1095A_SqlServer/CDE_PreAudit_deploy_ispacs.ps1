...
$Dir = Get-ChildItem -Path $FolderPath -Filter CDE_PreAudit.ispac
...
#$environment.Variables.Add(“CustomerIDA”, [System.TypeCode]::String, "C111", "$false", "Customer ID")
$environment.Variables.Add(“ERR_Import_ConnectionString”, [System.TypeCode]::String, "Data Source=localhost;Initial Catalog=ERR_Import;Provider=SQLNCLI11.1;Integrated Security=SSPI;Auto Translate=$false;", $false, "ERR_Import")
...
$ERR_Import_ConnectionString="ERR_Import_ConnectionString"

$Variable = $Catalog.Folders[$FolderName].Environments[$EnvironmentName].Variables[$ERR_Import_ConnectionString]
 
 Write-Host "var: $Variable"
 if (-not $Variable)
  {
environment.Variables.Add(“ERR_Import_ConnectionString”, [System.TypeCode]::String, "Data Source=localhost;Initial Catalog=ERR_Import;Provider=SQLNCLI11.1;Integrated Security=SSPI;Auto Translate=$false;", $false, "ERR_Import")
 $environment.Alter()
